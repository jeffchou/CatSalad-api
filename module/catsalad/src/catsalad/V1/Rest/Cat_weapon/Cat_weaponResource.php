...
class Cat_weaponResource extends AbstractResourceListener
{
    protected $mapper;
    ...
    public function create($data)
    {
        ...
        $catId = $routeParams[CatWeaponJsonKey::CatId];

        $data = get_object_vars($data);
        $weapon_id = $data[CatWeaponJsonKey::Id];

        $weapon = $this->mapper->replaceWeapon($catId, $weapon_id);
