...
class Attack_pattern_contentResource extends AbstractResourceListener
{
    protected $mapper;
    ...
    public function fetchAll($params = array())
    {
        try {
            ...
            $patternId = $routeParams[AttackPatternJsonKey::AttackPatternId];

            $result = $this->mapper->fetchByPatternId($patternId);
        }
        catch (\Exception $e) {
